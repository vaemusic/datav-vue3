<template>
  <div class="dv-border-box-1" ref="borderBox1">
    ...
    <svg width="150px" height="150px" :key="item" v-for="item in state.border" :class="`${item} dv-border`">
      ...
      <polygon :fill="state.mergedColor[0]"
        ...
        <animate attributeName="fill" :values="`${state.mergedColor[0]};${state.mergedColor[1]};transparent`" dur="1s"
